  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    config = function() -- This is the function that runs, AFTER loading
      ...
      require('which-key').register {
        ...
        ['<leader>d'] = { name = '[D]oc: Debug, Dropbar, Symbols...', _ = 'which_key_ignore' },
        ['<leader>r'] = { name = '[R]ename', _ = 'which_key_ignore' },
        ['<leader>s'] = { name = '[S]earch', _ = 'which_key_ignore' },
        ['<leader>w'] = { name = '[W]orkspace', _ = 'which_key_ignore' },
        ['<leader>g'] = { name = '[G]it', _ = 'which_key_ignore' },
        ['<leader>gc'] = { name = '[G]it: [C]ommit...', _ = 'which_key_ignore' },
        ['<leader>ih'] = { name = 'Toggle [I]nlay [H]ints', _ = 'which_key_ignore' },
        ['<leader>t'] = { name = '[T]ests', _ = 'which_key_ignore' },
        ['<leader>td'] = { name = '[T]ests: [D]ebug...', _ = 'which_key_ignore' },
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Code actions used to be defined like this:
          -- -- Execute a code action, usually your cursor needs to be on top of an error
          -- -- or a suggestion from your LSP for this to activate.
          -- -- map('<leader>ca', vim.lsp.buf.code_action, '[C]ode [A]ction')
          -- but they can utilise visual mode for the range argument (which is better), like this:
          vim.keymap.set({ 'v', 'n' }, '<leader>ca', vim.lsp.buf.code_action, { buffer = event.buf, desc = 'LSP: [C]ode [A]ction' })
