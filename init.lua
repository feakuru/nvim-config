...
-- nvim-ufo recommended configs for folds
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      -- nvim-ufo manual capability extension
  ...
  -- Highlight todo, notes, etc in comments
  {
    ...
    opts = { signs = false },
    keys = {
      { '<leader>*', '<Cmd>TodoTrouble<CR>', desc = 'TODOs in Trouble' },
    },
  },

  -- An improved interface for quickfixes and other such lists
  {
    'folke/trouble.nvim',
